<template>
    <div id="OverlaySection" class="fixed z-50 top-0 left-0 w-full h-screen bg-[#000000] bg-opacity-50 p-3">
            <button class="absolute right-3 cursor-pointer" @click="closeOverlay()">
                <Close :size="27" fillColor="#FFFFFF"/>

            </button>
         <div class=" max-w-6xl h-[calc(100%-100px)] mx-auto mt-auto bg-white rounded-xl ">
            <div class=" flex items-center justify-between w-full rounded-xl p-3 border-b border-b-gray-300">
                 <ArrowLeft :size="30" fillColor="#000000" @click="closeOverlay()"/>
                 <div class=" text-lg font-extrabold">New reel</div>
                 <button class=" text-lg text-blue-500 hover:text-gray-50 font-extrabold">
                    share
                 </button>
